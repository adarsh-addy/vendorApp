...
e.preventDefault();
const resp=await axios.post("http://localhost:4000/backend/save", {
  vendorname,
  bank_acc_no,
  bank_name,
  address,
    ...
    <div className="container">
      <form className="registration">
        ...
        <label>
          ...
          <input type="text" id="vendorname"  onChange={(e)=>SetVendorname(e.target.value)} required />
        ...
        <label>
          ...
          <input type="text" id="bankname" onChange={(e)=>SetBank_name(e.target.value)}  required />
          </label>

        <label>
          <span>Address 1</span>
          <textarea  id="address1" onChange={(e)=>SetAddress(e.target.value)}></textarea>
        </label>
        <label>
          <span>Address 2</span>
          <textarea  id="address2"onChange={(e)=>SetAddress(e.target.value)}></textarea>
        </label>
        <label>
          <span>City</span>
          ...
          <input type="number" id="zipcode" onChange={(e)=>SetZip_code(e.target.value)} required />
          </label>
